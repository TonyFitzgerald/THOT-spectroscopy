function [f_range, n_sam, alpha_sam, e_sam]=UWA_reflection_s(fd_proc,n_1,n_2)
f_range=find(fd_proc.f>0&fd_proc.f<=4);
n_0=1;
costheta0=sqrt(1-(sind(30))^2); % cos theta air
costheta1=sqrt(1-(n_1/n_0*sind(30))^2); % cos theta window
sintheta1=sqrt(1-costheta1^2);
costheta2=sqrt(1-(n_2/n_1*sintheta1)^2); % cos theta sample
