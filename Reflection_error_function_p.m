function f = Reflection_error_function_p(x,R,n_1,n_2)
n_0=1;
sintheta0=0.5;
...
R_ref0=1;
    ...
    R_ref0=(n_2*costheta1-n_1*costheta2)/(n_2*costheta1+n_1*costheta2);
end
R_sam0=(n_sam*costheta1-n_1*costheta_sam)/(n_sam*costheta1+n_1*costheta_sam);
R0=R_sam0/R_ref0;
